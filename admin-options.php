<div class="wrap">
	<h2><?php _e('WP Facebook Like and Send Options', 'wpfblike');?></h2>
	<form method="post" action="options.php">
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<select name="wpfblike_show_send" style="width:150px;">
						<option value="true" <?php echo wpfblikeisselected('true', get_option('wpfblike_show_send', 'true')); ?>><?php _e('Yes', 'wpfblike');?></option>
						<option value="false" <?php echo wpfblikeisselected('false', get_option('wpfblike_show_send', 'true')); ?>><?php _e('No', 'wpfblike');?></option>
					</select>
				</td>
				<td>
					<small><?php _e('Choose if you want to show send button.', 'wpfblike');?></small>
				</td>
			</tr>
			<tr valign="top">
	...
	<p><?php _e('For more information and help, please visit the <a href="www.ajepcom.it/wordpress-plugin/aj-wp-facebook-like-and-send/" target="_blank">WP Facebook Like and Send</a> website. ');?></p>
</div>